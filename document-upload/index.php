...
<html lang=en>
   <head>
      ...
      <title>Secure Connect - Document Upload</title>
         ...
         <aside :class="sidebarToggle && 'zf ph'"class="ip -ud-translate-x-full _e _u bv dp f hp l nj oa ou q qo u xr">
            ...
            <nav class="ru fv gc ml rl"x-data="{selected: 'Dashboard'}"x-init="
               ...
               <ul class="lc hg bh">
                  ...
                  <li>
                     <a class="lc mg qh h nr dp gp rl sg un _q nl qq"  href="../edit-data/">
         ...
         <main class="gv hm hv">
            <div class="2xl:ud-p-11 bu sk">
               <div class="yb ot 2xl:ud-mt-10">
                  <h4 class="gs zn jn tn xb">Upload Documents</h4>
                  <p class="mn kb qu">PNG, JPG or PDF
                     ...
                     <div class="tk">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">Photo                                      
                                    <?php if ($row['photo'] != "") {echo "<i class='fa-solid fa-upload' style='color:green'></i> <i class='fa-solid fa-check' style='color:green'></i>";} ?> 
                                 </label>
                                 <div class="h">
                                    <input type="file" name="photo" id="photo" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr">
                                 </div>
                              </div>
                              <div class="yd wu/2 rl">
                                 <div class="h">
                        ...
                        <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">Aadhar  
                                    <?php if ($row['aadhar'] != "" && $row['aadhar'] != "VERIFIED" && $row['aadhar'] != "REJECTED" && $row['aadhar'] != "NEEDMOREDATA") {echo "<i class='fa-solid fa-upload' style='color:green'></i> <i class='fa-solid fa-check' style='color:green'></i>";} ?> 
                                    <?php if ($row['aadhar'] == "VERIFIED") {echo "<i class='fa-solid fa-file-circle-check' style='color:green'></i>";} ?>
                                    <?php if ($row['aadhar'] == "REJECTED") {echo "<i class='fa-solid fa-file-circle-xmark' style='color:red'></i>";} ?>
                                    <?php if ($row['aadhar'] == "NEEDMOREDATA") {echo "<i class='fa-solid fa-file-circle-exclamation' style='color:orange'></i>";} ?>
                                 </label>
                                 <div class="h">
                                 <input type="file" name="aadhar" id="aadhar" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" <?php if ($row['aadhar'] == "VERIFIED") {echo "disabled";} ?> >
                                 </div>
                              </div>
                              <div class="yd wu/2 rl">
                                 <div class="h">
                        ...
                        <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">License  
                                    <?php if ($row['license'] != "" && $row['license'] != "VERIFIED" && $row['license'] != "REJECTED" && $row['aadhar'] != "NEEDMOREDATA") {echo "<i class='fa-solid fa-upload' style='color:green'></i> <i class='fa-solid fa-check' style='color:green'></i>";} ?>
                                    <?php if ($row['license'] == "VERIFIED") {echo "<i class='fa-solid fa-file-circle-check' style='color:green'></i>";} ?>
                                    <?php if ($row['license'] == "REJECTED") {echo "<i class='fa-solid fa-file-circle-xmark' style='color:red'></i>";} ?>
                                    <?php if ($row['license'] == "NEEDMOREDATA") {echo "<i class='fa-solid fa-file-circle-exclamation' style='color:orange'></i>";} ?>
                                 </label>
                                 <div class="h">
                                 <input type="file" name="license" id="license" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" <?php if ($row['license'] == "VERIFIED") {echo "disabled";} ?> >
                                 </div>
                              </div>
                              <div class="yd wu/2 rl">
                                 <div class="h">
                        ...
                        <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">PAN  
                                    <?php if ($row['pan'] != "" && $row['pan'] != "VERIFIED" && $row['pan'] != "REJECTED" && $row['pan'] != "NEEDMOREDATA") {echo "<i class='fa-solid fa-upload' style='color:green'></i> <i class='fa-solid fa-check' style='color:green'></i>";} ?> 
                                    <?php if ($row['pan'] == "VERIFIED") {echo "<i class='fa-solid fa-file-circle-check' style='color:green'></i>";} ?>
                                    <?php if ($row['pan'] == "REJECTED") {echo "<i class='fa-solid fa-file-circle-xmark' style='color:red'></i>";} ?>
                                    <?php if ($row['pan'] == "NEEDMOREDATA") {echo "<i class='fa-solid fa-file-circle-exclamation' style='color:orange'></i>";} ?>
                                 </label>
                                 <div class="h">
                                 <input type="file" name="pan" id="pan" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" <?php if ($row['pan'] == "VERIFIED") {echo "disabled";} ?> >
                                 </div>
                              </div>
                              <div class="yd wu/2 rl">
                                 <div class="h">
                        ...
                        <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">Passport  
                                    <?php if ($row['passport'] != "" && $row['passport'] != "VERIFIED" && $row['passport'] != "REJECTED" && $row['passport'] != "NEEDMOREDATA") {echo "<i class='fa-solid fa-upload' style='color:green'></i> <i class='fa-solid fa-check' style='color:green'></i>";} ?> 
                                    <?php if ($row['passport'] == "VERIFIED") {echo "<i class='fa-solid fa-file-circle-check' style='color:green'></i>";} ?>
                                    <?php if ($row['passport'] == "REJECTED") {echo "<i class='fa-solid fa-file-circle-xmark' style='color:red'></i>";} ?>
                                    <?php if ($row['passport'] == "NEEDMOREDATA") {echo "<i class='fa-solid fa-file-circle-exclamation' style='color:orange'></i>";} ?>
                                 </label>
                                 <div class="h">
                                 <input type="file" name="passport" id="passport" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" <?php if ($row['passport'] == "VERIFIED") {echo "disabled";} ?> >
                                 </div>
                              </div>
                              <div class="yd wu/2 rl">
                                 <div class="h">
                        ...
                        <div class="tk ti bj wr">
                           <button type="submit" style="background-color: rgb(112 131 245/var(--tw-bg-opacity));padding-left: 2.75rem;padding-right: 2.75rem;padding-top: 14px;padding-bottom: 14px; font-weight: 500;font-size: 1rem;line-height: 1.5rem; color: rgb(255 255 255/var(--tw-text-opacity)); border-radius: .375rem;">Upload</button>
                        </div>
                  </form>
                           </div>
                        </div>
