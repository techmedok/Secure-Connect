...
<html lang=en>
   <head>
      ...
      <title>Secure Connect - Profile</title>
         ...
         <main class="gv hm hv">
            <div class="2xl:ud-p-11 bu sk">
               <div class="yb ot 2xl:ud-mt-10">
                  <h4 class="gs zn jn tn xb">Profile</h4>
                  <p class="mn kb qu">Your Profile...
                     ...
                     <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 ...
                                 <div class="h">
                                    <input type="text" readonly name="name" id="name" value="<?php echo $row['name']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                        ...
                        <div class="tk ti bj wr">
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 ...
                                 <div class="h">
                                    <input type="text" readonly name="email" id="email" value="<?php echo $row['email']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['dob'] == "0000-00-00") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl" >
                                 <label class="fb jc un zn gs">Date of Birth</label>
                                 <div class="h">
                                    <input type="date" readonly name="dob" id="dob" value="<?php echo $row['dob']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['cc'] == "0" && $row['phone'] == "0") {echo "style='display: none;'";} ?>>
                              <h3 class="un kn zn gs">Contact Number</h3>
                        </div>

                        <div class="tk ti bj wr" <?php if ($row['cc'] == "0" && $row['phone'] == "0") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl" <?php if ($row['cc'] == "0") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">Country Code</label>
                                 <div class="h">
                                    <input type="text" readonly name="cc" id="cc" value="<?php echo $row['cc']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                              ...
                              <div class="yd wu/2 rl" <?php if ($row['cc'] == "0") {echo "style='display: none;'";} ?>>
                                 ...
                                 <div class="h">
                                    <input type="text" readonly name="phone" id="phone" value="<?php echo $row['phone']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['dno'] == "" && $row['street'] == "" && $row['city'] == "" && $row['state'] == "" && $row['country'] == "") {echo "style='display: none;'";} ?>>
                              <h3 class="un kn zn gs">Address</h3>
                        </div>

                        <div class="tk ti bj wr" <?php if ($row['dno'] == "" && $row['street'] == "") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl" <?php if ($row['dno'] == "") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">Door No.</label>
                                 <div class="h">
                                    <input type="text" readonly name="dno" id="dno" value="<?php echo $row['dno']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                                       <i class="fa-solid fa-door-open"></i>
                                    </span>
                                 </div>
                              </div>
                              <div class="yd wu/2 rl" <?php if ($row['street'] == "") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">Street</label>
                                 <div class="h">
                                    <input type="text" readonly name="street" id="street" value="<?php echo $row['street']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['city'] == "" && $row['state'] == "") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl" <?php if ($row['city'] == "") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">City</label>
                                 <div class="h">
                                    <input type="text" readonly name="city" id="city" value="<?php echo $row['city']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                                       <i class="fa-regular fa-tree-city"></i>
                                    </span>
                                 </div>
                              </div>
                              <div class="yd wu/2 rl" <?php if ($row['state'] == "") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">State</label>
                                 <div class="h">
                                    <input type="text" readonly name="state" id="state" value="<?php echo $row['state']; ?>"  class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['country'] == "") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">Country</label>
                                 <div class="h">
                                    <input type="text" readonly name="country" id="country" value="<?php echo $row['country']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['cardno'] == "0" && $row['cvv'] == "0" && $row['expdate'] == "") {echo "style='display: none;'";} ?>>
                              <h3 class="un kn zn gs">Payments</h3>
                        </div>


                        <div class="tk ti bj wr" <?php if ($row['cardno'] == "0") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl">
                                 <label class="fb jc un zn gs">Card Number</label>
                                 <div class="h">
                                    <input type="text" readonly name="cardno" id="cardno"  value="<?php echo $row['cardno']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                        ...
                        <div class="tk ti bj wr" <?php if ($row['cvv'] == "0" && $row['expdate'] == "") {echo "style='display: none;'";} ?>>
                           <div class="-ud-mx-4 lc jg">
                              <div class="yd wu/2 rl" <?php if ($row['cvv'] == "0") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">CVV</label>
                                 <div class="h">
                                    <input type="text" readonly name="cvv" id="cvv"  value="<?php echo $row['cvv']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
                              ...
                              <div class="yd wu/2 rl" <?php if ($row['expdate'] == "") {echo "style='display: none;'";} ?>>
                                 <label class="fb jc un zn gs">Expiry Date</label>
                                 <div class="h">
                                    <input type="month" readonly name="expdate" id="expdate" value="<?php echo $row['expdate']; ?>" class="yd qh ni bj yk an zn vo xo fr kr lr mr">
                                    <span class="g j/2 x -ud-translate-y-1/2">
