...
$query2 = "SELECT * FROM user_".$username.";";
...
<html lang=en>
   <head>
      ...
      <title>Secure Connect - Dashboard</title>
         ...
         <main class="gv hm hv">
            <div class="2xl:ud-p-11 bu sk">
               <div class="yb ot 2xl:ud-mt-10">
                  <h4 class="gs zn jn tn xb">Sites</h4>
                  <p class="mn kb qu">Sites that have access to your data
                     ...
                     <div class="nf oh">
                                 <?php
                                    ...
                                    if ($result2->num_rows > 0) {
                                       echo "<table class='rh yd yf'>";
                                       echo "
                                          <tr class='vi bj wr'>
                                             <th class='rm sm ff sl'><p class='gs zn un gn'>Sno.</p></th>
                                             <th class='sl rl ff'><p class='gs zn un gn'>Site</p></th>
                                             <th class='sl rl gf'><p class='gs zn un gn'>Date</p></th>
                                             <th class='sl rl hf'> <p class='gs zn un gn'>Access to</p></th>
                                             <th class='sl if nm tm'><p class='gs zn un in'></p></th>
                                          </tr>
                                          <tbody>
                                       ";
                                       while($rowd = $result2->fetch_assoc()) {
                                            $yes_columns = '';
                                            foreach ($rowd as $key2 => $value2) {
                                                if ($value2 == 'YES') {
                                                    $yes_columns .= $column_names[$key2] . ', ';
                                                }
                                            }
                                            $yes_columns = rtrim($yes_columns, ', ');
                                        

                                          echo "
                                             <tr class='vi bj wr'>
                                                <td class='_l rm sm'><p>".$r."</p></td>
                                                <td class='_l rl'><h5 class='un'>".$rowd['sitename']."</h5><p class='mn'>".$rowd['siteurl']."</p></td>
                                                <td class='_l rl'><p>".$rowd['date']."</p></td>
                                                <td class='_l rl'><p>".$yes_columns."</p></td>
                                                <td class='_l in nm tm'><button class='mg un dp gp rl ol _n _q ej nc ni pg qq sh'>Revoke</button><!-- rowd[''] --></td>
                                             </tr>
                                          ";
                                          $r=$r+1;
                                       }
