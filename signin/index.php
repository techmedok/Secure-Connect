...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  // If the form has been submitted, process the login attempt
  ...
  if (empty($email) || empty($password)) {
    ...
    // Get the user record from the users table using the email
    ...
    if (!$user) {
      ...
      // If the email and password are correct, create a session and redirect to the dashboard page
         ...
         <div class="ab ac ad[1400px]">
            <div class="ae af ag">
               ...
               <div class="menu-wrapper ac ak ag lg:ae">
                  ...
                  <nav class="aw a4 a5 az[999] ae aD a7 af ar a1 aE aF aG dark:a2 dark:aE lg:aH lg:aI lg:aJ lg:aK lg:aL lg:dark:aK">
                     <ul class="af aM lg:ae lg:aN lg:aO xl:aP">
                        <li class="menu-item">
                           <a href="index.html#features" class="menu-scroll aQ af aR aS aT hover:aU dark:aV dark:hover:aU lg:aW">
                           Features
                           </a>
                        </li>
                        <li class="menu-item">
                           <a href="index.html#about" class="menu-scroll aQ af aR aS aT hover:aU dark:aV dark:hover:aU lg:aW">
                           About
                           </a>
                        </li>
                        <li class="menu-item">
                           <a href="index.html#work-process" class="menu-scroll aQ af aR aS aT hover:aU dark:aV dark:hover:aU lg:aW">
                           How It Work
                           </a>
                        </li>
                        <li class="menu-item">
                           <a href="index.html#support" class="menu-scroll aQ af aR aS aT hover:aU dark:aV dark:hover:aU lg:aW">
                           Support
                           </a>
                        </li>
                        <li class="submenu-item menu-item aX ac">
                           <a href="javascript:void(0)" class="submenu-taggler aQ af aR aS aT hover:aU group-hover:aU dark:aV dark:hover:aU lg:aW">
                              Pages
                              <span class="aY">
                           ...
                           <ul class="submenu ak a_ a10 a9 lg:a11 lg:a3 lg:a12[120%] lg:ah lg:a13[250px] lg:a14 lg:a1 lg:a15 lg:a16 lg:a17 lg:a18 lg:a19 lg:group-hover:a1a lg:group-hover:a1b lg:group-hover:a1c dark:lg:a1d dark:lg:a1e[#15182A] lg:dark:a1f">
                              <li>
                                 <a href="blog-grid.html" class="a1g aQ af ar aF aR aT hover:aU dark:aV dark:hover:aU">
                                 Blog Grids
                                 </a>
                              </li>
                              <li>
                                 <a href="blog-details.html" class="a1g aQ af ar aF aR aT hover:aU dark:aV dark:hover:aU">
                                 Blog Details
                                 </a>
                              </li>
                              <li>
                                 <a href="404.html" class="a1g aQ af ar aF aR aT hover:aU dark:aV dark:hover:aU">
                                 404 Error
                                 </a>
                              </li>
                              <li>
                                 <a href="../signin" class="a1g aQ af ar aF aR aT hover:aU dark:aV dark:hover:aU">
                                 Sign In
                                 </a>
                              </li>
                              <li>
                                 <a href="../signup" class="a1g aQ af ar aF aR aT hover:aU dark:aV dark:hover:aU">
                                 Sign Up
                                 </a>
                              </li>
                           </ul>
               ...
               <div class="a1h[60px] ae af a1i lg:a1j">
                  ...
                  <a href="../signin" class="ak a1m[10px] a1n aR aS aT hover:aU dark:aV dark:hover:aU sm:a1o">
                  Sign In
                  </a>
                  <a href="../signup" class="ak a1p a1q a1m[10px] a1r[30px] aR aS aV hover:a1s sm:a1o">
                  Sign Up
                  </a>
               </div>
            </div>
            ...
            <div class="ab a1v lg:ad[1250px]">
               <div class="wow fadeInUp a1w a7 ad[520px] a14 a1e[#F8FAFB] a3E a1n a19 dark:a1e[#15182A] dark:a1f sm:a3A[50px]" data-wow-delay=".2s">
                  <div class="a2g ae af a2E a1p a3u a8 a1 a3N a1r[10px] dark:aa dark:a2Q">
                     <a href="../signin" class="ah a7 a2u a1q a48 aF aR aS aV hover:a1s">
                     Sign In
                     </a>
                     <a href="../signup" class="ah a7 a2u a48 aF aR aS aT hover:a1q hover:aV dark:aV">
                     Sign Up
                     </a>
                  </div>
                  <div class="aF">
                     <h3 class="a1z[10px] a2p at aT dark:aV sm:a1A[28px]">
                  ...
                  <form method="POST">
                     <div class="a2d">
                        <label for="email" class="a1z[10px] ah a2C aT dark:aV">
                        Your Email
                        </label>
                     ...
                     <div class="a4d a1z[30px] ae a1F ag">
                        <div class="a7 a4e sm:a1L/2">
                           <label for="keep-signed" class="a1U ae a1k a4f af aR a1B sm:a1W">
                              <input type="checkbox" name="keep-signed" id="keep-signed" class="keep-signed a1l" />
                              <span class="box a1h[10px] ae au[22px] a13[22px] af ar a4g a33[.7px] a8 a1 dark:aa dark:a2">
                        ...
                        <div class="a7 a4e sm:a1L/2">
                           <a href="javascript:void(0)" class="aR aU hover:a3L sm:a2D">
                           Forgot Password?
                           </a>
                        </div>
                     </div>
                     <button type="submit" class="ae a7 ar a1p a1q a49 aR aS aV hover:a1s">
                     Sign In
                     </button>
                  </form>
               </div>
                     ...
                     <div class="a1E ae a1F">
                        <div class="a7 a1G sm:a1L/2 md:a1M/12 lg:a1M/12">
                           <div class="wow fadeInUp a1J" data-wow-delay=".25s">
                              <h3 class="a1x a1A[22px] aS aT dark:aV">
                                 Home
                              </h3>
                              <ul class="as[10px]">
                                 <li>
                                    <a href="javascript:void(0)" class="a1o aR a1B hover:aU">
                                    Product
                                    </a>
                                 </li>
                                 <li>
            ...
            <div class="ab ad[1390px]">
               <div class="a1O ae a1F">
                  <div class="a1P a7 a1Q lg:a1R lg:a1L/3">
                     <p class="a1S aF aR aV lg:a1T lg:a17">
                  ...
                  <div class="a7 a1Q md:a1L/2 lg:a1L/3">
                     <div class="ae af ar a1Z sm:aN md:a1i lg:a1i">
                        <a href="javascript:void(0)" class="aR aV">
                        Privacy Policy
                        </a>
                        <a href="javascript:void(0)" class="aR aV">
