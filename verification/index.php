...
$query2 = "SELECT * FROM verification WHERE username = '$username'";
$result2 = mysqli_query($conn, $query2);
$row2 = mysqli_fetch_assoc($result2);


$isaadhar = $row['aadhar'] == "" || $row['aadhar'] == "VERIFIED" || $row['aadhar'] == "REJECTED" || $row['aadhar'] == "NEEDMOREDATA";
$islicense = $row['license'] == "" || $row['license'] == "VERIFIED" || $row['license'] == "REJECTED" || $row['license'] == "NEEDMOREDATA";
$ispan = $row['pan'] == "" || $row['pan'] == "VERIFIED" || $row['pan'] == "REJECTED" || $row['pan'] == "NEEDMOREDATA";
$ispassport = $row['passport'] == "" || $row['passport'] == "VERIFIED" || $row['passport'] == "REJECTED" || $row['passport'] == "NEEDMOREDATA";
...
<html lang=en>
   <head>
      ...
      <title>Secure Connect - Verification</title>
         ...
         <main class="gv hm hv">
            <div class="2xl:ud-p-11 bu sk">
               <div class="yb ot 2xl:ud-mt-10">
                  <h4 class="gs zn jn tn xb">Verification</h4>
                  <p class="mn kb qu">Upload the Documents for Verification...

                  <form method="post" action="../../process/apply.php">
                  <div class="rh bj ni nj wr xr">
                     ...
                     <div class="tk">
                           <div class="-ud-mx-4 lc jg">
                              ...
                              <div class="h" style="padding-bottom: 20px;<?php if ($isaadhar && $islicense && $ispan && $ispassport) {} else {echo " display: none;";} ?>">
                                 Upload at least one document to initiate verification process...
                              </div>


                                 <div class="h" style="padding-bottom: 20px;<?php if ($isaadhar) {echo " display: none;";} ?>">
                                    <input type="checkbox" name="aadhar" id="aadhar" value="aadhar" <?php if ($row2['status']=="ONQUEUE") {echo "disabled";} ?> <?php if ($row2['aadhar']=="YES") {echo "checked";} ?>>
                                    <label for="aadhar" class="fb un zn gs">&nbsp;&nbsp;Aadhar</label><br>
                                 </div>

                                 <div class="h" style="padding-bottom: 20px;<?php if ($islicense) {echo " display: none;";} ?>">
                                    <input type="checkbox" name="license" id="license" value="license" <?php if ($row2['status']=="ONQUEUE") {echo "disabled";} ?> <?php if ($row2['license']=="YES") {echo "checked";} ?>>
                                    <label for="license" class="fb un zn gs">&nbsp;&nbsp;License</label><br>
                                 </div>

                                 <div class="h" style="padding-bottom: 20px;<?php if ($ispan) {echo " display: none;";} ?>">
                                    <input type="checkbox" name="pan" id="pan" value="pan" <?php if ($row2['status']=="ONQUEUE") {echo "disabled";} ?> <?php if ($row2['pan']=="YES") {echo "checked";} ?>>
                                    <label for="pan" class="fb un zn gs">&nbsp;&nbsp;PAN</label><br>
                                 </div>
                                 <div class="h" style="padding-bottom: 20px;<?php if ($ispassport) {echo " display: none;";} ?>">
                                    <input type="checkbox" name="passport" id="passport" value="passport" <?php if ($row2['status']=="ONQUEUE") {echo "disabled";} ?> <?php if ($row2['passport']=="YES") {echo "checked";} ?>>
                                    <label for="passport" class="fb un zn gs">&nbsp;&nbsp;Passport</label>
                                 </div>

                                 <div class="h" style="padding-bottom: 20px;<?php if ($row2['status']=="READY") {echo " display: none;";} ?>">
                                    Your Application for Verification is on Queue.
                                 </div>
                        ...
                        <div class="tk ti bj wr" style="<?php if ($row2['status']=="ONQUEUE") {echo "display: none;";} ?><?php if ($isaadhar && $islicense && $ispan && $ispassport){echo " display: none;";} ?>">
                           <button type="submit" style="background-color: rgb(112 131 245/var(--tw-bg-opacity));padding-left: 2.75rem;padding-right: 2.75rem;padding-top: 14px;padding-bottom: 14px; font-weight: 500;font-size: 1rem;line-height: 1.5rem; color: rgb(255 255 255/var(--tw-text-opacity)); border-radius: .375rem;">Apply Verification</button>
                        </div>
                  </form>
